          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="alignright">
                  ...
                  <a class="btn btn-small" title="{PHP.L.ListMaingroup}" href="{ADMIN_USERS_ROW_GRP_JUMPTO_URL}"><i class="icon-share-alt"></i></a>
                  <a class="btn btn-small" title="{PHP.L.ListGroup}" href="{ADMIN_USERS_ROW_GRP_ID|cot_url('users', 'gm=$this')}"><i class="icon-list"></i></a>
                  <a class="btn btn-small" title="{PHP.L.Edit}" href="{ADMIN_USERS_ROW_GRP_TITLE_URL}"><i class="icon-pencil"></i></a>

                  <!-- IF {ADMIN_USERS_ROW_GRP_SKIPRIGHTS} -->
                  <a class="btn btn-small disabled"><i class="icon-eye-open"></i> {PHP.L.short_rights}</a>
                  <!-- ELSE -->
                  <a class="btn btn-small" title="{PHP.L.Rights}" href="{ADMIN_USERS_ROW_GRP_RIGHTS_URL}"><i class="icon-eye-open"></i> {PHP.L.short_rights}</a>
                  <!-- ENDIF -->
        ...
        <form action="{ADMIN_USERS_FORM_URL}" method="post">
          <div class="row-fluid">
            ...
            <div class="span4">
              ...
              <div class="help-text">{PHP.L.DisableRightsInfo}</div>
