...
$L['ExtfHTMLHelp']         = 'Available Parameters';
$L['ExtfHTML']             = 'HTML template for form field';
$L['ExtfHTMLInfo'] = array(
        'input'        => '{$name} {$value} {$attrs} {$error}',
        'textarea'     => '{$name} {$value} {$rows} {$cols} {$attrs} {$error}',
        'inputint'     => '{$name} {$value} {$attrs} {$error}',
        'double'       => '{$name} {$value} {$attrs} {$error}',
        'currency'     => '{$name} {$value} {$attrs} {$error}',
        'range'        => '{$name} {$options} {$attrs} {$error}',
        'select'       => '{$name} {$options} {$attrs} {$error}',
        'checkbox'     => '{$name} {$value} {$checked} {$title} {$attrs}',
        'checklistbox' => '{$name} {$value} {$checked} {$title} {$attrs}',
        'radio'        => '{$name} {$value} {$checked} {$title} {$attrs}',
        'country'      => '{$name} {$options} {$attrs} {$error}',
        'datetime'     => '{$day} {$month} {$year} {$hour} {$minute}',
        'file'         => '{$name} {$value} {$filepath} {$attrs} {$error} {$delname}',
);
...
$L['adm_ref_prunelow'] = 'Prune referers with less than 5 visitors';
